...
<<<<<<< HEAD:Code/Maze runner/test1_bam_trai/test1_bam_trai.ino
// Motor driver pins
int ENA = 2;
int motorA1 = 3;
int motorA2 = 4;
...
>>>>>>> fbf116a96e50d20a539d9dcf48360228937cc31f:Code/Maze runner/bam_trai/bam_trai.ino
...
<<<<<<< HEAD:Code/Maze runner/test1_bam_trai/test1_bam_trai.ino
    if (flag == 0) {
      digitalWrite(STBY, HIGH); // Kích hoạt driver
      analogWrite(ENA, 80);
      analogWrite(ENB, 80);
      if (tin_hieu == 1) {
        do {
